#!/usr/bin/env node
/**
 * Standalone Stdio Model Context Protocol (MCP) Server for Nutri-DataHub
 * Compatible with Cursor (~/.cursor/mcp.json) and Claude Desktop (claude_desktop_config.json).
 */
...
import { generateScoreSummary, generateColumnDescriptions, extractAllergenWarnings } from '../src/services/llm';
...
function startServer() {
  ...
  console.error('[nutri-datahub-mcp] Server initialized and listening on stdio.');
}
